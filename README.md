...
is inherently unsafe <strong>infact entire source code is open</strong> and you can build your own distrbution following [Build](#build) section but its due to the paperwork and money involved in getting the certificates to sign the applications which can cost as much as $699 a year.
